...
import com.ync.hackathon.presentation.dto.request.EmailRequestDto;
import com.ync.hackathon.infrastructure.repository.MemberRepository;
import com.ync.hackathon.application.PasswordResetMailService;
...
public class PasswordResetController {
    ...
    public ResponseEntity<String> sendPasswordResetEmail(@Valid @RequestBody EmailRequestDto emailDto) {
        Optional<RegisterForm> optionalMember = memberRepository.findByNameAndEmailAndPhone(emailDto.getName(), emailDto.getEmail(), emailDto.getPhone());
